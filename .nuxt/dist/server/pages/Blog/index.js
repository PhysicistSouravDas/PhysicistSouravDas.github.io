...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/Blog/index.vue?vue&type=template&id=3d2a63b6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<p>"+_vm._ssrEscape("This is "+_vm._s(_vm.$route.name)+" 's Index page.")+"</p> "),_vm._l((_vm.blogposts),function(blog){return _c('v-container',{key:blog.id},[_c('v-card',{attrs:{"nuxt":"","to":blog.path}},[_c('v-card-title',[_vm._v(_vm._s(blog.title))]),_vm._v(" "),_c('v-card-subtitle',[_vm._v("\n        "+_vm._s(blog.author.name)+"\n        "),_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-chip',_vm._g({attrs:{"label":"","outlined":"","small":"","attrs":attrs}},on),[_vm._v("\n              "+_vm._s(_vm.daysAgo(blog.createdAt))+"\n            ")])]}}],null,true)},[_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.formatDate(blog.createdAt)))])])],1),_vm._v(" "),_c('v-card-text',[_c('nuxt-content',{attrs:{"document":{ body: blog.excerpt }}}),_vm._v(" "),_c('v-btn',{staticClass:"mx-auto"},[_vm._v("Read More")])],1)],1)],1)})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/Blog/index.vue?vue&type=template&id=3d2a63b6&
...
/* harmony default export */ var Blogvue_type_script_lang_js_ = ({
  async asyncData({
    ...
    const blogposts = await $content('blog', {
      deep: true
    }).sortBy('createdAt', 'desc').fetch(); // console.log(blogposts)
  ...
  methods: {
    daysAgo(postDate) {
      ...
      var relativeTime = __webpack_require__(131);

      this.$dayjs.extend(relativeTime);
      const dateToDisplay = this.$dayjs().to(postDate); // const dateToDisplay = this.$dayjs(postDate).fromNow();
...
var VTooltip = __webpack_require__(166);
...
/* harmony default export */ var VTooltip_VTooltip = (Object(mixins["a" /* default */])(colorable["a" /* default */], delayable, dependent["a" /* default */], menuable).extend({
  name: 'v-tooltip',
  props: {
    closeDelay: {
      type: [Number, String],
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VChip: VChip["a" /* default */],VContainer: VContainer["a" /* default */],VTooltip: VTooltip_VTooltip})
